...
// A user-initiated refresh should retry immediately instead of waiting out the hour-long
// backoff a previous Keychain denial armed.
func resetClaudeTokenBackoff() { claudeTokenDeniedUntil = 0 }
